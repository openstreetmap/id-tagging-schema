...
- [`/highway/cycleway/crossing.json`](../cycleway/crossing.json) + [`/highway/cycleway/crossing/*.json`](../cycleway/crossing)
- [`/highway/path/crossing.json`](../path/crossing.json)         + [`/highway/path/crossing/*.json`](../path/crossing)
